...
function alignment (name, label, fields) {
  ...
  if (fields?.alignment_direction === 'BOTH') {
    specific.default = fields?.default || {
      horizontal_align: 'LEFT',
      vertical_align: 'CENTER'
    }
  } else if (fields?.alignment_direction === 'HORIZONTAL') {
    specific.default = fields?.default || {
      horizontal_align: 'LEFT'
    }
  } else if (fields?.alignment_direction === 'VERTICAL') {
    specific.default = fields?.default || {
      vertical_align: 'CENTER'
    }
  }
 ...
 * @property {Array} [choices] Array of value and label pairs. Values listed first.
...
function spacing (name, label, fields) {
  ...
  if (fields?.limits) specific.default = fields?.limits
  if (fields?.default) specific.default = fields?.default
...
function font (name, label, fields) {
  ...
  specific.default = fields?.default || {}
  if (fields?.variant) specific.variant = fields?.variant
  return { ...common, ...specific }
}
